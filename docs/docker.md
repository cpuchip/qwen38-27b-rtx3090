...
`verify.sh --install` run at build time. KVarN is not preinstalled on this pin: its
0.28.0 patches do not apply on 0.29 (see [vllm-0.29.md](vllm-0.29.md)). Host prerequisites:

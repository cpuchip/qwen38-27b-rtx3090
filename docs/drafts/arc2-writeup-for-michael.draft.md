...
| Reproduction mode (DFLASH_TOKENS=15) | on this cohort, no gain in accepted tokens; positions 7 to 14 give 1.2 to 1.6 percent of accepted tokens; step cost 2.4x on this card on every boot measured, 0.3 percent on the native 3090; with async on and every step padded to 15 it is 3.7x here and 1.05x there | the cost is the Triton autotuner's choice on the 4090: with the race skipped, width 15 costs 4 ms more per step than width 7 (49.5 against 45 to 47); autotuned, width 7 lands at 23 or 45 by boot and width 15 at 56.5 every boot; the native 3090 is unimodal and unaffected; winner-printed boots running to name the kernel |

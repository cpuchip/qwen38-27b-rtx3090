From the second measurement campaign on this issue's question, 2026-09-05 (the record is docs/v0.28-validation.md on the cpuchip:v0.28-validation branch):
